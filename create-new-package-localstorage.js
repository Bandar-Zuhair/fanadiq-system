...
openSaveNewWebsiteLocalStorageDataName = function () {
...
function importIndexedDBDataName() {
    // Re-enable scrolling
...
function updateIndexedDBDataNames(localStorageControllerDivId) {
